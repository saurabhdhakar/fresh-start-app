...
const fr: Dict = {
  ...
  "fb.userNotFound": "Aucun compte trouvé pour cet e-mail.",
  "fb.wrongPassword": "Mot de passe incorrect.",
  "fb.invalidCredential": "E-mail ou mot de passe incorrect.",
  "fb.emailInUse": "Cet e-mail est déjà utilisé.",
