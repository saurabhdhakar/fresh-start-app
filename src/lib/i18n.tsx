...
const en = {
  ...
  "fb.userNotFound": "No account found with this email.",
  "fb.wrongPassword": "Incorrect password.",
  "fb.invalidCredential": "Email or password is incorrect.",
  "fb.emailInUse": "This email is already in use.",
...
const hinglish: Dict = {
  ...
  "fb.userNotFound": "Is email se koi account nahi mila.",
  "fb.wrongPassword": "Password galat hai.",
  "fb.invalidCredential": "Email ya password galat hai.",
  "fb.emailInUse": "Ye email pehle se use ho raha hai.",
...
const hi: Dict = {
  ...
  "fb.userNotFound": "इस ईमेल से कोई अकाउंट नहीं मिला।",
  "fb.wrongPassword": "पासवर्ड ग़लत है।",
  "fb.invalidCredential": "ईमेल या पासवर्ड ग़लत है।",
  "fb.emailInUse": "यह ईमेल पहले से इस्तेमाल में है।",
...
const ar: Dict = {
  ...
  "fb.userNotFound": "لا يوجد حساب بهذا البريد الإلكتروني.",
  "fb.wrongPassword": "كلمة المرور غير صحيحة.",
  "fb.invalidCredential": "البريد الإلكتروني أو كلمة المرور غير صحيحة.",
  "fb.emailInUse": "هذا البريد الإلكتروني مستخدم بالفعل.",
